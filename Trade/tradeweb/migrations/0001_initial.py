# Generated by Django 3.2 on 2021-04-19 01:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tradeweb.tb_school')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('phoneID', models.BigIntegerField(primary_key=True, serialize=False)),
                ('nickName', models.CharField(max_length=20)),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tradeweb.student')),
